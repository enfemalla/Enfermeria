...
function crearMalla() {
  // Limpia contenido antes de crear para evitar duplicados
...
function actualizarRamos() {
  ...
  ramos.forEach(ramo => {
    ...
    if (!div) return; // Previene errores si el div no existe
    ...
    if (completados.includes(ramo.id)) {
      ...
      // Solo activar si los prerrequisitos están completos
...
// Espera a que el DOM esté listo para crear la malla
